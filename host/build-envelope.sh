#!/usr/bin/env bash
# host/build-envelope.sh — builds a no-jaguar firmware envelope whose sole boot
# container is the Porta supervisor.
#
# Produces firmware-esp32.envelope at the repo root with the supervisor installed
# (trigger=boot, default). Flash it with:
